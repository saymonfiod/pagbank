...
// Função para formatar CNPJ no formato 00.000.000/0000-00
...
app.post("/gerar-pdf", async (req, res) => {
  ...
  // Margem superior reduzida para layout compacto
  ...
  // Informações da empresa, incluindo CNPJ formatado
  ...
  const dataHora = `Data/Hora: ${new Date().toLocaleString("pt-BR", {
  ...
  res.set({
    ...
    "Content-Disposition": `attachment; filename=Proposta_PagBank_${cnpj.replace(
      /[^\d]/g,
      ""
    )}.pdf`,
  });
